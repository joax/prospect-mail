...
CssInjector.main = `
    ...
    .IU6B5 {
        ...
        box-shadow: 0px 0px 30px var(--neutralLight) !important;
    }
    ...
    .IU6B5b_OtjYTV0snjXPm {
        border-radius: 5px !important;
    }

    .IsfphVj_YEgd6DmRaRlR {
        align-self: center !important;
    }

    /* Folder List */

    .Uon3IiTBtr0wa9wepSdw {
    ...
    #Pivot64-Tab0[class*="linkIsSelected-"] {
        ...
        color: var(--fallback-headerButtonsBackground) !important;
    ...
    .LjsqxheEi6gQnbRfPJtk,
    .uSUBcoT_xz05cFRhuJQd {
        font-weight: 700 !important;
    }

    .Rl6TwEZKxkhOgLe9cZyj.SMPjQtvPyCguMLsZarDA .xfjq3NWbpycK5fsD16mO {
        color: var(--themeDark) !important;
    }

    .xfjq3NWbpycK5fsD16mO {
        color: black;
        font-weight: 600;
    }
    ...
    .personaMarginThreeColumn .check-208,
    .personaMarginThreeColumn .check-193,
    .personaMarginThreeColumn .root-191,
    .personaMarginThreeColumn .root-205,
    .personaMarginThreeColumn .root-206,
    .personaMarginThreeColumn .root-440,
    .personaMarginThreeColumn .circle-192,
    .personaMarginThreeColumn .circle-270,
    .personaMarginThreeColumn .circle-207,
    ...
    .personaMarginThreeColumn .circle-206 {
        top: auto !important;
        left: auto !important;
    }

    .personaMarginThreeColumn .root-191::before,
    .personaMarginThreeColumn .root-440::before,
    .personaMarginThreeColumn .root-205::before,
    .personaMarginThreeColumn .root-206::before {
    ...
    .BW6l9,
    .uLemZZbqfz8uBGm1kyLM,
    .YE9Rk8OtUS0jhKIdgrIZ,
    .BW6l9NBd8XUsIdkU7Dct {
        overflow: -moz-scrollbars-none;
        -ms-overflow-style: none;  
        scrollbar-width: none;  
    }

    .jEpCF::-webkit-scrollbar,
    .YE9Rk::-webkit-scrollbar,
    .BW6l9::-webkit-scrollbar,
    .YE9Rk8OtUS0jhKIdgrIZ::-webkit-scrollbar,
    .BW6l9NBd8XUsIdkU7Dct::-webkit-scrollbar { 
        display: none;  /* Safari and Chrome */
    }
    ...
    .um8sQ {
        ...
        background: var(--messageMobileWarningPrimary) !important;
    }
    ...
    .jblWR,
    .jblWR.kHEgm,
    .jblWRNBGWZ0jwdufJUx7.kHEgmiG55IAQQPsd9pZe,
    ...
    .PRYun,
    .as1Cm,
    .PRYunnJqGx8BRpKiYkj7,
    .as1CmN9B7Yonk9XNcw9U {
        border-radius: 5px !important;
    }

    a[id^='OLK_Beautified_'] {
        padding: .7em 1em;
        border-radius: 5px !important;
    ...
    a[id^='OLK_Beautified_']:hover {
        background-color: var(--themeDark) !important;
        color: white !important;
    }

    a[id^='OLK_Beautified_'] img {
        margin-right: .6em;
    }
    ...
    .o365cs-base .o365sx-neutral-lighterAlt-hover-background:hover {
        background: white !important;
        background-color: white !important;
    }
    ...
    #O365fpcontainerid {
        border-left: 1px solid var(--neutralLighter) !important;
        box-shadow: none !important;
    }
    ...
    .FW8Cjy4_UeUQ8V9uT4uz,
    .bfh7qly0QAwQK792dqyP .fEZxuej9iZ4ONooJEoMH,
    .bfh7qly0QAwQK792dqyP {
        width: 100% !important;
    }
    ...
    .Qe0mkKjWju05rFJgNiRK>div {
        background-color: white;
    }

    .cnJmpDUSQTs8pXoE3T5r {
        border-color: #F4F4F4;
        z-index: 2;
    }

    .feJp8Jv34RP26tXz0vUk {
        margin-left: 8px;
